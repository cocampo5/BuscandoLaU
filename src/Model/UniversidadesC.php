            ...
            <div class="col-md-6">
                <form class="navbar-form navbar-left" role="search" action="BusquedaU.php" id="buscando" method="post">
                    <div class="form-group">
                        <input type='text' name='busqueda'  id='busqueda'  placeholder='¿Qué quieres buscar?' class='form-control'>
                    </div>
...
$("#csalud").change(function(){
    filtrar();
});
$("#cambientales").change(function(){
    filtrar();
});
$("#ceducacion").change(function(){
    filtrar();
});
...
if(document.getElementById("csalud").checked){
filtros = filtros+"1";
}else{
    filtros = filtros+"0";
}
if(document.getElementById("cambientales").checked){
filtros = filtros+"1";
}else{
    filtros = filtros+"0";
}
if(document.getElementById("ceducacion").checked){
filtros = filtros+"1";
}else{
    filtros = filtros+"0";
}
